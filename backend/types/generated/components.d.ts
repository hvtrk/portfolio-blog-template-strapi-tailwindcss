...
export interface FooterFooter extends Struct.ComponentSchema {
  ...
  attributes: {
    categories: Schema.Attribute.Component<'footer.footer-links', true>;
    footerLogo: Schema.Attribute.Component<'footer.footer-logo', false>;
    legalLinks: Schema.Attribute.Component<'footer.footer-links', true>;
    menuLinks: Schema.Attribute.Component<'footer.footer-links', true>;
    socialLinks: Schema.Attribute.Component<'footer.footer-links', true>;
  };
}
